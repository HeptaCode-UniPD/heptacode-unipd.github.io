...
#let lista-ruoli = (
    ...
    "Programmatore",   "Assente", //Amerigo Vegliante
...
- Nuove metriche aggiunte al Piano di Qualifica e alle Norme di Progetto
...
Inoltre, è stato deciso che l'ultimo commit prima di un'analisi va salvato su MongoDB, in modo 
= Conclusione
