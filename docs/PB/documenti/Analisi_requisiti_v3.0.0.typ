...
#tabella-viola(
  ...
  [R-118-F-P],[Il Business Owner deve visualizzare le spese affrontate per un progetto],[#link(<UCBO1>)[UCBO1], #link(<UCBO1.1>)[UCBO1.1], #link(<UCBO1.1.2>)[UCBO1.1.2]],
  [R-119-F-P],[Il Business Owner deve poter comparare il budget a disposizione con le spese affrontate],[#link(<UCBO1>)[UCBO1], #link(<UCBO1.1>)[UCBO1.1], #link(<UCBO1.1.3>)[UCBO1.1.3]],
  [R-120-F-P],[Il Business Owner deve poter visualizzare il dettaglio di un progetto],[#link(<UCBO2>)[UCBO2]],
  [R-121-F-P],[Il Business Owner deve poter visualizzare il nome di un progetto],[#link(<UC10.1>)[UC10.1]],
  [R-122-F-P],[Il Business Owner deve poter cambiare il budget complessivo per un progetto],[#link(<UCBO2.1>)[UCBO2.1], #link(<UCBO2.7>)[UCBO2.7]],
  [R-123-F-P],[Il Business Owner deve poter annullare il cambiamento del budget complessivo],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-124-F-P],[Il Business Owner deve poter cambiare la spesa sostenuta per un progetto],[#link(<UCBO2.2>)[UCBO2.2], #link(<UCBO2.7>)[UCBO2.7]],
  [R-125-F-P],[Il Business Owner deve poter annullare il cambiamento della spesa sostenuta per un progetto],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-126-F-P],[Il Business Owner deve poter visualizzare il nome del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.1>)[UCBO2.3.1]],
  [R-127-F-P],[Il Business Owner deve poter visualizzare la mail di contatto del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.2>)[UCBO2.3.2]],
  [R-128-F-P],[Il Business Owner deve poter visualizzare la data di creazione di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.3>)[UCBO2.3.3]],
  [R-129-F-P],[Il Business Owner deve poter visualizzare la lista delle tecnologie utilizzate in un progetto],[#link(<UCBO2.4>)[UCBO2.4]],
  [R-130-F-P],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, il logo della tecnologia],[#link(<UCBO2.4.2>)[UCBO2.4.2]],
  [R-131-F-P],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, il nome della tecnologia],[#link(<UCBO2.4.3>)[UCBO2.4.3]],
  [R-109-F-P],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, l'utilizzo che si fa della tecnologia],[#link(<UCBO2.4.4>)[UCBO2.4.4]],
  [R-132-F-P],[Il Business Owner deve poter visualizzare la lista del team di sviluppo che fa parte di un progetto],[#link(<UCBO2.5>)[UCBO2.5]],
  [R-133-F-P],[Il Business Owner, per ogni elemento della lista del team di sviluppo, deve visualizzare il nome dello sviluppatore],[#link(<UCBO2.5.1>)[UCBO2.5.1], #link(<UCBO2.5.2>)[UCBO2.5.2]],
  [R-134-F-P],[Il Business Owner, per ogni elemento della lista del team di sviluppo, deve visualizzare il ruolo dello sviluppatore all'interno di un progetto],[#link(<UCBO2.5.1>)[UCBO2.5.1], #link(<UCBO2.5.3>)[UCBO2.5.3]],
  [R-135-F-P],[Il Business Owner deve poter visualizzare i dettagli di un developer che lavora ad un suo progetto],[#link(<UCBO3>)[UCBO3]],
  [R-136-F-P],[Il Business Owner deve poter visualizzare il numero di progetti ai quali lo sviluppatore ha preso parte],[#link(<UCBO3.1>)[UCBO3.1]],
  [R-137-F-P],[Il Business Owner deve poter visualizzare le tecnologie che uno sviluppatore può utilizzare],[#link(<UCBO3.2>)[UCBO3.2]],
  [R-138-F-P],[Il Business Owner deve poter visualizzare i ruoli che uno sviluppatore può assumere],[#link(<UCBO3.3>)[UCBO3.3]],
)
#pagebreak()
