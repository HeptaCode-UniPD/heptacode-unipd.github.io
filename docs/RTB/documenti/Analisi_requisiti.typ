...
#table(
  ...
  [R-126-F-D],[Il Business Owner deve visualizzare il nome del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.1>)[UCBO2.3.1]],
  ...
  [R-132-F-D],[Il Business Owner deve visualizzare la lista del team di sviluppo che fa parte di un progetto],[#link(<UCBO2.5>)[UCBO2.5]],
