...
- *Scenari alternativi:* Il sistema non rileva progetti: mostra uno stato vuoto e invita a creare il primo progetto tramite il pulsante "Nuovo Progetto" (*<\<extend>>* 
  //#link(<UC7>)[[UC7]]).

- *Postcondizioni:* Il Project Manager naviga verso il dettaglio di un progetto o ne crea uno nuovo.

- *Estensioni:* 
  //#link(<UC7>)[[UC7]], #link(<UC9>)[[UC9]].
