...
#table(
  ...
  [R-120-F-D],[Il Business Owner deve poter visualizzare il dettaglio di un progetto],[#link(<UCBO2>)[UCBO2]],
  [R-121-F-D],[Il Business Owner deve poter visualizzare il nome di un progetto],[#link(<UC10.1>)[UC10.1]],
  [R-122-F-D],[Il Business Owner deve poter cambiare il budget complessivo per un progetto],[#link(<UCBO2.1>)[UCBO2.1], #link(<UCBO2.7>)[UCBO2.7]],
  [R-123-F-D],[Il Business Owner deve poter annullare il cambiamento del budget complessivo],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-124-F-D],[Il Business Owner deve poter cambiare la spesa sostenuta per un progetto],[#link(<UCBO2.2>)[UCBO2.2], #link(<UCBO2.7>)[UCBO2.7]],
  [R-125-F-D],[Il Business Owner deve poter annullare il cambiamento della spesa sostenuta per un progetto],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-126-F-D],[Il Business Owner deve poter visualizzare il nome del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.1>)[UCBO2.3.1]],
  [R-127-F-D],[Il Business Owner deve poter visualizzare la mail di contatto del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.2>)[UCBO2.3.2]],
  [R-128-F-D],[Il Business Owner deve poter visualizzare la data di creazione di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.3>)[UCBO2.3.3]],
  ...
  [R-135-F-D],[Il Business Owner deve poter visualizzare i dettagli di un developer che lavora ad un suo progetto],[#link(<UCBO3>)[UCBO3]],
  [R-136-F-D],[Il Business Owner deve poter visualizzare il numero di progetti ai quali lo sviluppatore ha preso parte],[#link(<UCBO3.1>)[UCBO3.1]],
  [R-137-F-D],[Il Business Owner deve poter visualizzare le tecnologie che uno sviluppatore può utilizzare],[#link(<UCBO3.2>)[UCBO3.2]],
  [R-138-F-D],[Il Business Owner deve poter visualizzare i ruoli che uno sviluppatore può assumere],[#link(<UCBO3.3>)[UCBO3.3]],
)
