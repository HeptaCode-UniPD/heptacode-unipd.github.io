...
#let storia_modifiche = (
  ...
  ("0.8.0", "2026-01-12", "Angela Favaro", "Nicola Simionato", "UC Utente e Developer"),
...
- *Scenario principale:*
  ...
  + L'Utente Registrato visualizza il grafico percentuale delle statistiche di analisi documentazione (*<\<include>>* #link(<UC5.1>)[[UC5.1]]).
  + L'Utente Registrato visualizza il grafico percentuale delle statistiche di analisi di test (*<\<include>>* #link(<UC5.2>)[[UC5.2]]).
  + L'Utente Registrato visualizza il grafico percentuale delle statistiche correttezza OWASP (*<\<include>>* #link(<UC5.4>)[[UC5.4]]).
...
- *Scenario principale:*
  ...
  + L'Utente Registrato visualizza un menù a tendina per selezionare la tipologia di repository che desidera (tutti/senza progetto).
...
- *Generalizzazioni:* #link(<UC8.0.1>)[[UC8.0.1]]
...
- *Scenario principale:*
  ...
  + Il Developer completa l'autenticazione tramite il provider esterno GitHub.
  + Il Developer conferma l'operazione di sincronizzazione finale.
  + Il Developer visualizza l'interfaccia di inserimento per il token GitHub.
  + Il Developer inserisce il proprio token.
  + Il Developer conferma l'inserimento del token.
  + Il Developer visualizza la dashboard con i repository aggiunti.
...
- *Precondizioni:* Il Developer si trova sulla scheda dei procedimenti in corso #link(<UCD8>)[[UCD8]]. Il Developer vuole visualizzare quali remediation sono state avviate e non ancora confermate tramite merge con il repository coinvolto. 
...
- *Precondizioni:* Il Developer si trova sulla scheda dei procedimenti in corso #link(<UCD8>)[[UCD8]]. Il Developer vuole visualizzare quali analisi sono state avviate e non ancora concluse. 
...
- *Scenario principale:*
  + Il Developer visualizza i grafici relativi all'analisi sui test, i quali riportano la percentuale di correttezza della stessa.
...
- *Scenario principale:*
  + Il Developer visualizza i grafici relativi all'analisi OWASP, i quali riportano la percentuale di correttezza della stessa.
...
- *Scenario principale:*
  + Il Developer visualizza i grafici relativi all'analisi sulla documentazione, i quali riportano la percentuale di correttezza della stessa.
...
#figure([#image("../../asset/UC/project-manager/ucpm1-4.png", height: 8cm)], caption: [UCPM1.4 - Aggiunta developer a progetto])
...
- *Scenario principale*:
  + Il Project Manager visualizza i dati come descritto in #link(<UCPM1.6>)[[UCPM1.6]].
...
- *Scenario principale:*
  ...
  + Il Project Manager visualizza una barra di ricerca per il nome dei developer.
...
- *Inclusioni:* #link(<UCPM1.6.1>)[[UCPM1.6.1]]

- *Generalizzazioni:* #link(<UCPM1.4.2>)[[UCPM1.4.2]]).
...
#tabella-viola(
  ...
  [R-39-F-O],[Il Developer deve essere in grado di visualizzare il dettaglio del file sul quale è stato proposto un cambiamento],[#link(<UCD6.1>)[UCD6.1]],
  ...
  // BO
  [R-116-Q-O],[Il Business Owner deve poter visualizzare la lista dei propri progetti],[#link(<UCBO1>)[UCBO1], #link(<UC9>)[UC9]],
  [R-117-F-O],[Il Business Owner deve poter visualizzare il budget complessivo per il proprio progetto],[#link(<UCBO1>)[UCBO1], #link(<UCBO1.1>)[UCBO1.1], #link(<UCBO1.1.1>)[UCBO1.1.1]],
  [R-118-F-O],[Il Business Owner deve visualizzare le spese affrontate per un progetto],[#link(<UCBO1>)[UCBO1], #link(<UCBO1.1>)[UCBO1.1], #link(<UCBO1.1.2>)[UCBO1.1.2]],
  [R-119-F-O],[Il Business Owner deve poter comparare il budget a disposizione con le spese affrontate],[#link(<UCBO1>)[UCBO1], #link(<UCBO1.1>)[UCBO1.1], #link(<UCBO1.1.3>)[UCBO1.1.3]],
  [R-120-F-O],[Il Business Owner deve poter visualizzare il dettaglio di un progetto],[#link(<UCBO2>)[UCBO2]],
  [R-121-F-O],[Il Business Owner deve poter visualizzare il nome di un progetto],[#link(<UC10.1>)[UC10.1]],
  [R-122-F-O],[Il Business Owner deve poter cambiare il budget complessivo per un progetto],[#link(<UCBO2.1>)[UCBO2.1], #link(<UCBO2.7>)[UCBO2.7]],
  [R-123-F-O],[Il Business Owner deve poter annullare il cambiamento del budget complessivo],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-124-F-O],[Il Business Owner deve poter cambiare la spesa sostenuta per un progetto],[#link(<UCBO2.2>)[UCBO2.2], #link(<UCBO2.7>)[UCBO2.7]],
  [R-125-F-O],[Il Business Owner deve poter annullare il cambiamento della spesa sostenuta per un progetto],[#link(<UCBO2.6>)[UCBO2.6]],
  [R-126-F-O],[Il Business Owner deve poter visualizzare il nome del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.1>)[UCBO2.3.1]],
  [R-127-F-O],[Il Business Owner deve poter visualizzare la mail di contatto del Project Manager di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.2>)[UCBO2.3.2]],
  [R-128-F-O],[Il Business Owner deve poter visualizzare la data di creazione di un progetto],[#link(<UCBO2.3>)[UCBO2.3], #link(<UCBO2.3.3>)[UCBO2.3.3]],
  [R-129-F-O],[Il Business Owner deve poter visualizzare la lista delle tecnologie utilizzate in un progetto],[#link(<UCBO2.4>)[UCBO2.4]],
  [R-130-F-O],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, il logo della tecnologia],[#link(<UCBO2.4.2>)[UCBO2.4.2]],
  [R-131-F-O],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, il nome della tecnologia],[#link(<UCBO2.4.3>)[UCBO2.4.3]],
  [R-109-F-O],[Il Business Owner deve visualizzare, per ogni elemento di una lista di stack tecnologico, l'utilizzo che si fa della tecnologia],[#link(<UCBO2.4.4>)[UCBO2.4.4]],
  [R-132-F-O],[Il Business Owner deve poter visualizzare la lista del team di sviluppo che fa parte di un progetto],[#link(<UCBO2.5>)[UCBO2.5]],
  [R-133-F-O],[Il Business Owner, per ogni elemento della lista del team di sviluppo, deve visualizzare il nome dello sviluppatore],[#link(<UCBO2.5.1>)[UCBO2.5.1], #link(<UCBO2.5.2>)[UCBO2.5.2]],
  [R-134-F-O],[Il Business Owner, per ogni elemento della lista del team di sviluppo, deve visualizzare il ruolo dello sviluppatore all'interno di un progetto],[#link(<UCBO2.5.1>)[UCBO2.5.1], #link(<UCBO2.5.3>)[UCBO2.5.3]],
  [R-135-F-O],[Il Business Owner deve poter visualizzare i dettagli di un developer che lavora ad un suo progetto],[#link(<UCBO3>)[UCBO3]],
  [R-136-F-O],[Il Business Owner deve poter visualizzare il numero di progetti ai quali lo sviluppatore ha preso parte],[#link(<UCBO3.1>)[UCBO3.1]],
