...
#table(
  ...
  [*T-26-S*], [Verificare che l'Utente possa visualizzare il nome del progetto associato a un repository], [R-26-F-D], [NI],
  ...
  [*T-85-S*], [Verificare che l'Utente possa visualizzare un repository sulla piattaforma esterna GitHub], [R-85-F-P], [NI],
  ...
  [*T-124-S*], [Verificare che il Business Owner possa cambiare la spesa effettuata in un progetto], [R-124-F-D], [NI],
...
Con il passaggio alla fase successiva (Sprint 10-13), che prevede l'impiego di risorse con tariffe orarie inferiori, si prevede un miglioramento del CPI e quindi una diminuizione progressiva del valore dell'EAC. La curva dell'EAC dovrebbe quindi convergere verso il BAC entro la fine del progetto.
