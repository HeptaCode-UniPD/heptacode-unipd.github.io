...
#table(
  ...
  [*T-16-S*], [Verificare che l'Utente possa aggiungere un repository pubblico al sistema], [R-16-F-O], [NI],
  [*T-17-S*], [Verificare che l'Utente possa aggiungere un repository privato al sistema], [R-17-F-D], [NI],
  [*T-18-S*], [Verificare che l'Utente possa inserire il Personal Access Token collegato al suo account], [R-18-F-D], [NI],
  [*T-19-S*], [Verificare che l'Utente visualizzi un messaggio di errore in caso di inserimento di Personal Access Token non valido], [R-19-F-D], [NI],
  [*T-20-S*], [Verificare che l'Utente possa annullare la procedura di inserimento di un repository nel sistema], [R-20-F-O], [NI],
  [*T-21-S*], [Verificare che l'Utente possa inserire l'URL del repository da inserire nel sistema], [R-21-F-O], [NI],
  [*T-22-S*], [Verificare che l'Utente visualizzi un messaggio di errore in caso di inserimento di URL non valido], [R-22-F-O], [NI],
  [*T-23-S*], [Verificare che l'Utente possa visualizzare la lista dei repository personali], [R-23-F-O], [NI],
  [*T-24-S*], [Verificare che l'Utente possa selezionare una preferenza sulla tipologia di repository visualizzata], [R-24-F-O], [NI],
  [*T-25-S*], [Verificare che l'Utente possa visualizzare il nome di un repository], [R-25-F-O], [NI],
  [*T-26-S*], [Verificare che l'Utente possa visualizzare il nome del progetto assocciato a un repository], [R-26-F-D], [NI],
  [*T-27-S*], [Verificare che l'Utente possa visualizzare l'indicatore di visibilità di un repository], [R-27-F-O], [NI],
  [*T-28-S*], [Verificare che l'Utente possa visualizzare la lista dei progetti ai quali contribuisce], [R-28-F-O], [NI],
  [*T-29-S*], [Verificare che l'Utente possa visualizzare il nome di un progetto], [R-25-F-O], [NI],
  [*T-30-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi sulla documentazione di un progetto], [R-30-F-O], [NI],
  [*T-31-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi sui test di un progetto], [R-31-F-O], [NI],
  [*T-32-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi OWASP di un progetto], [R-32-F-O], [NI],
  [*T-33-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi sulla documentazione di un repository], [R-31-F-O], [NI],
  [*T-34-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi sui test di un repository], [R-34-F-O], [NI],
  [*T-35-S*], [Verificare che l'Utente possa visualizzare le statistiche dell'analisi OWASP di un repository], [R-35-F-O], [NI],
  [*T-36-S*], [Verificare che l'Utente, dopo l'analisi sui test per un repository, visualizzi la lista dei file sui quali è stata proposta remedation], [R-36-F-O], [NI],  
  ...
  [*T-92-S*], [Verificare che l'Utente possa cercare un repository tramite barra di ricerca], [R-92-F-P], [NI],
  [*T-85-S*], [Verificare che l'Utente possa visualizzare un repostory sulla piattaforma esterna GitHub], [R-85-F-P], [NI],
  [*T-78-S*], [Verificare che il Developer possa autenticarsi in maniera tale che gli venga assegnato il ruolo di "Developer"], [R-78-F-P], [NI],
  ...
  [*T-79-S*], [Verificare che il Project Manager possa autenticarsi in maniera tale che gli venga assegnato il ruolo di "Project Manager"], [R-79-F-O], [NI],
  ...
  [*T-93-S*], [Verificare che il Project Manager possa visualizzare una lista di repository potenzialmente aggiungibili a un suo progetto], [R-93-F-O], [NI],
  ...
  [*T-97-S*], [Verificare che il Project Manager possa visualizzare una lista di developer potenzialmente aggiungibili a un suo progetto], [R-97-F-O], [NI],
  ...
  [*T-116-S*], [Verificare che il Business Owner possa visualizzare la lista dei propri progetti], [R-116-F-D], [NI],
  [*T-117-S*], [Verificare che il Business Owner possa visualizzare il budget complessivo per il proprio progetto], [R-117-F-D], [NI],
  [*T-118-S*], [Verificare che il Business Owner possa visualizzare le spese effettuate di un progetto], [R-118-F-D], [NI],
  [*T-119-S*], [Verificare che il Business Owner possa visualizzare una comparazione fra budget e spese effettuate], [R-119-F-D], [NI],
  [*T-120-S*], [Verificare che il Business Owner possa visualizzare i dettagli di un suo progetto], [R-117-F-D], [NI],
  [*T-121-S*], [Verificare che il Business Owner possa visualizzare il nome di un progetto], [R-121-F-D], [NI],
  [*T-122-S*], [Verificare che il Business Owner possa cambiare il budget complessivo di un suo progetto], [R-121-F-D], [NI],
  [*T-123-S*], [Verificare che il Business Owner possa annullare l'operazione di cambio del budget di un suo progetto], [R-123-F-D], [NI],
  [*T-124-S*], [Verificare che il Business Owner possa cambiare la spesa  effettuta in un progetto], [R-124-F-D], [NI],
  [*T-125-S*], [Verificare che il Business Owner possa annullare l'operazione di cambio spesa effettuata in un suo progetto], [R-125-F-D], [NI],
  [*T-126-S*], [Verificare che il Business Owner possa visualizzare il nome del Project Manager di un progetto], [R-126-F-D], [NI],
  [*T-127-S*], [Verificare che il Business Owner possa visualizzare la mail del Project Manager di un progetto], [R-127-F-D], [NI],
  [*T-128-S*], [Verificare che il Business Owner possa visualizzare la data di creazione di un progetto], [R-128-F-D], [NI],
