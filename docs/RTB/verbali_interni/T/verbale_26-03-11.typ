...
= Svolgimento
== Discussione sulle modifiche da apportare alla struttura architetturale del progetto
È stata proposta una modifica alla macro-struttura del progetto, che è stata accettata unimanemente da tutto il gruppo. La struttura in questione è la seguente:
