...
Nel conseguente documento (_Dichiarazione degli impegni_) è presente un approfondimento dei temi analizzati; inoltre è stata stilata una lista dei rischi e, per ciascuno di essi, vengono indicate le possibili strategie attuabili per mitigarli.
= Rendicontazione ore e costi
Lo studio preliminare condotto ha portato a pianificare l’impegno di ciascun membro del gruppo  a *92 ore produttive*, ruotando in maniera equa ed omogenea l’assunzione di tutti i ruoli coinvolti. \ Ogni componente di Hepta Code si impegna a ricoprire un unico ruolo per volta, al fine di sperimentare il nostro Way of Working (la cui descrizione è disponibile nella repository) da tutte le diverse prospettive.

Il costo stimato del progetto è di *12845€* e la data di consegna è stata pianificata il *16 Marzo 2026*. Una dissertazione più approfondita di queste stime è consultabile all’interno del documento '_Dichiarazione degli impegni_' presente nella repository.
